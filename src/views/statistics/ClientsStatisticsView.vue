  ...
  <div class="client-report-page">
    ...
    <div class="header-row">
      ...
      <div class="title-container">
        <h2 class="page-title">
          <span class="link-back" @click="$router.back()">Statistics</span> / Client Statistics
        </h2>
      </div>
    ...
    <!-- LOADING / ERROR -->
    <div v-if="isLoading" class="center-msg">Loading Statistics...</div>
...
async function loadClients() {
  try {
    ...
    const res = await axios.get('http://localhost:8000/api/statistics/clients', {
...
async function loadClientReport(clientId) {
  ...
  try {
    ...
    const res = await axios.get(`http://localhost:8000/api/statistics/clients/${clientId}`, {
      headers: { Authorization: `Bearer ${auth.token}` }
    })
